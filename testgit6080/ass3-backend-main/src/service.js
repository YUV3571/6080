...
export const register = (email, password, name) => dataLock((resolve, _) => {
...
export const threadsGet = (authUserId, start) => dataLock((resolve, _) => {
...
export const threadGet = (authUserId, threadId) => dataLock((resolve, _) => {
  if (!(threadId in threads)) {
...
export const threadNew = (authUserId, title, isPublic, content) => dataLock((resolve, _) => {
...
export const threadUpdate = (authUserId, threadId, title, isPublic, content, lock) => dataLock((resolve, _) => {
...
export const threadLikeToggle = (authUserId, threadId, turnon) => dataLock((resolve, _) => {
  if (turnon) {
...
export const threadDelete = (authUserId, threadId) => dataLock((resolve, _) => {
...
export const threadWatchToggle = (authUserId, threadId, turnon) => dataLock((resolve, _) => {
  if (turnon) {
...
export const commentsGet = (authUserId, threadId) => dataLock((resolve, _) => {
...
export const commentNew = (authUserId, threadId, parentCommentId, content) => dataLock((resolve, _) => {
...
export const commentUpdate = (authUserId, commentId, content) => dataLock((resolve, _) => {
  if (content) comments[commentId].content = content;
  resolve(comments[commentId]);
});

export const commentLikeToggle = (authUserId, commentId, turnon) => dataLock((resolve, _) => {
  if (turnon) {
...
export const commentDelete = (authUserId, commentId) => dataLock((resolve, _) => {
...
export const assertValidUserId = (userId) => dataLock((resolve, _) => {
  if (!(userId in users)) {
...
export const assertAdminUserId = (userId) => dataLock((resolve, _) => {
...
export const userGet = (userId) => dataLock((resolve, _) => {
...
export const userUpdate = (authUserId, email, password, name, image) => dataLock((resolve, _) => {
